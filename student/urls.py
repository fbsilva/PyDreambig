...
urlpatterns = [
    ...
    path('settings/public_school/<int:school_id>/', views.public_school_edit, name='public_school'),
    ...
    path('school_save', views.school_save),
    path('grade_save', views.grade_save),
    path('level_save', views.level_save)
]
